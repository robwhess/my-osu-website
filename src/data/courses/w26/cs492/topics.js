const topics = [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs492-w26/BasicTodos',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs492-w26/GitHubSearch',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs492-w26/ViewModelGitHubSearch',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs492-w26/SettingsGitHubSearch',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs492-w26/RoomGitHubSearch',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
