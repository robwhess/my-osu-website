  ...
  assignments: [
    {
      ...
      link: 'https://docs.google.com/document/d/1PfJcNNEPoDHeyanKWbRdEPapGqiFz4PCOFmUdxOzt2s/edit?usp=sharing'
    },
    {
      title: 'Deliverable #1: Final Project Proposal',
      link: 'https://docs.google.com/document/d/11Eksl15siiLEHdT7aL6Qa086KYBLQ4EYJ2tltIM3-nc/edit?usp=sharing',
      due: {
        time: '11:59pm',
        day: 'Friday, 2/27/2026',
        location: 'on Canvas'
      },
      notes: [
        'Use [this Ed thread](https://edstem.org/us/courses/90441/discussion/7630950) to help connect with potential teammates.',
        'Submit [this form](https://forms.gle/DCPLhqfLSE1Drv4S8) if you just want to be assigned to a random team.'
      ]
    },
    {
      title: 'Deliverable #2: Code',
      link: 'https://classroom.github.com/a/E03MyMNH',
      due: {
    ...
    },
    {
      ...
      link: 'https://docs.google.com/document/d/1WVqzm2MzeoTCcqM5YB-eLncz0btfpc7GNC97cVRZ6ts/edit?usp=sharing',
      due: {
        time: '5:00pm',
        day: 'Friday, 3/20/2026',
        location: 'on Canvas'
      },
      notes: [
