const topics = [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs494-w26/components-to-apps',
        description: 'GitHub repo for code written in lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs494-w26/refs-and-effects',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs494-w26/using-react-router',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs494-w26/styling-options',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs494-w26/graphql-with-apollo',
        description: 'GitHub repo for code written in lecture'
      },
    ],
    readings: [
