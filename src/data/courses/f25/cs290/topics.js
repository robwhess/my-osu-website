const topics = [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Lecture doodles',
        link: 'https://drive.google.com/file/d/10QKn8uRX-6tz8ZCV3SYHPr6CBlj2Nqpy/view?usp=sharing',
        description: 'drawings from lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-f25/css',
        description: 'GitHub repo for code written in lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-f25/js-dom-manipulation',
        description: 'GitHub repo for code written in lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-f25/node-basics',
        description: 'GitHub repo for code written in lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-f25/user-content',
        description: 'GitHub repo for code written in lecture'
      }
    ],
    readings: [
