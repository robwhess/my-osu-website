  ...
  assignments: [
    {
      ...
      link: 'https://docs.google.com/document/d/16oSDO0w1YrwdLy7KFsJLlFCngRaatwzYCxNJlRayB2I/edit?usp=sharing',
    },
    {
      title: 'Deliverable #1: Final Project Proposal',
      link: 'https://docs.google.com/document/d/16U2uLCTHKwX7Cik-vzGQzh7TndFNNvej8DUD0Tq9fHc/edit?usp=sharing',
      due: {
        time: '11:59pm',
        day: 'Friday, 5/17/2024',
        location: 'on Canvas'
      }
    },
    {
      title: 'Deliverable #2: Code',
      link: 'https://classroom.github.com/a/OjlFa0Io',
      due: {
    ...
    {
      title: 'Deliverable #2b: Public API URL (CS 599 only)',
      link: 'https://canvas.oregonstate.edu/courses/1970824/assignments/9675384',
      due: {
        time: 'at the time of your grading demo',
        day: 'during finals week',
        location: 'on Canvas'
      ...
      notes: [
        'Grad teams must submit the public URL for their deployed API on Canvas.'
      ]
    },
    {
      title: 'Deliverable #3: Final Project Team Evaluation',
      link: 'https://docs.google.com/document/d/19EnHAvRkPQ5xLhGDXMvLf47DMxCRH9OtOslHHabMmwY/edit?usp=sharing',
      due: {
        time: '5:00pm',
