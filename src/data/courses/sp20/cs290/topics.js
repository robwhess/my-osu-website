const topics = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        link: 'https://drive.google.com/file/d/1AChDuKfDEpbHT6RbO3Xk5c-nCxrSHdy_/view?usp=sharing',
...

  {
    ...
    resources: [
      ...
      // {
      //   title: 'Example code',
      //   link: 'https://github.com/osu-cs290-f19/css',
      //   description: 'code written in lecture'
      // }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      // {
      //   title: 'Example code',
      //   link: 'https://github.com/osu-cs290-f19/js-fundamentals',
      //   description: 'code written in lecture'
      // }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      // {
      //   title: 'Example code',
      //   link: 'https://github.com/osu-cs290-f19/js-dom-manipulation',
      //   description: 'code written in lecture'
      // }
    ],
    readings: [
