const assignments = {
  ...
  assignments: [
    {
      link : 'https://classroom.github.com/a/Qie1G_dU',
      title: 'Assignment 1 &ndash; HTML and web publishing',
      due: {
        day: 'Wednesday, 4/8/2020',
        time: '11:59pm'
      },
      notes: [
    ...
    {
      link : 'https://classroom.github.com/a/1zaI-T5T',
      title: 'Assignment 3 &ndash; Client-side JS',
      due: {
        day: 'Monday, 5/11/2020',
        time: '11:59pm'
      },
      notes: [
        'Code Blog due **ON CANVAS** by assignment due date',
    ...
    {
      link : 'https://classroom.github.com/a/cZB7Q_Ml',
    ...
    {
      link : 'https://classroom.github.com/a/JVqXY5MN',
      title: 'Assignment 5 &ndash; Express serving and Handlebars templating',
      due: {
        day: '~~Monday, 6/1/2020~~ **Wednesday, 6/3/2020**',
        time: '11:59pm'
      },
      notes: [
        'Code Blog due **ON CANVAS** by assignment due date',
        '~~Demo due by 5:00pm on Friday, 6/12/2020~~ **No demo for this assignment**'
      ]
    }
  ],
