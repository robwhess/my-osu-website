const topics = [
  {
    ...
    resources: [
      ...
      },
      {
        ...
        link: 'https://drive.google.com/file/d/1ePw0SHByGgOXIMEbVLbg6ZQx4XKVPc7-/view?usp=sharing',
...

  {
    ...
    resources: [
      ...
      {
        title: 'Lecture doodles',
        link: 'https://drive.google.com/file/d/1eGgv_lrLVk1UH3JcNlF5rPKTCSbPc3ve/view?usp=sharing',
        description: 'drawings from lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-sp22/html',
        description: 'GitHub repo for code written in lecture'
      },
      {
        title: 'Lecture doodles',
        link: 'https://drive.google.com/file/d/1evf0UdF0ccEQ6rv5y7qqHH6rKa3RD5Lj/view?usp=sharing',
        description: 'drawings from lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-sp22/css',
        description: 'GitHub repo for code written in lecture'
      },
      {
        title: 'Lecture doodles',
        link: 'https://drive.google.com/file/d/1f31ElztQ3G4Dg_JwaVmhbDA6AR3sJLrM/view?usp=sharing',
        description: 'drawings from lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-sp22/js-fundamentals',
        description: 'GitHub repo for code written in lecture'
      },
      {
        title: 'Lecture doodles',
        link: 'https://drive.google.com/file/d/1fUgu7Qe5RTftQE8jXayBJQMNlsy3SKGk/view?usp=sharing',
        description: 'drawings from lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Lecture doodles',
        link: 'https://drive.google.com/file/d/1fSoCG_rvM6JXVuTbYYRbfYr3cXehVtcC/view?usp=sharing',
        description: 'drawings from lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      {
        title: 'Example code',
        link: 'https://github.com/osu-cs290-sp22/js-events',
        description: 'GitHub repo for code written in lecture'
      },
      {
      ...
      {
        title: 'Lecture doodles',
        link: 'https://drive.google.com/file/d/1fbcUE_zzpEdIcNL9osP-OjK4FL-Q2uKi/view?usp=sharing',
        description: 'drawings from lecture'
      }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      // {
      //   title: 'Example code',
      //   link: 'https://github.com/osu-cs290-f21/express-serving',
      //   description: 'GitHub repo for code written in lecture'
      // }
    ],
    readings: [
...

  {
    ...
    resources: [
      ...
      // {
      //   title: 'Example code',
      //   link: 'https://github.com/osu-cs290-f21/handlebars-templating',
      //   description: 'GitHub repo for code written in lecture'
      // }
    ],
    readings: [
