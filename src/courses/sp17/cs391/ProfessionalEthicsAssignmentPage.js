    ...
    return (
      <PageContent>
        <section className="assignment-box">
          ...
          <ul>
            <li><a href="https://docs.google.com/a/oregonstate.edu/presentation/d/1HiHcH_C80Oatx_kUgLLXbR_KGPbW3FM2hV1ha4acbwA/edit?usp=sharing" target="_blank">Assignment outline template</a></li>
          </ul>
