var calendar = [
    ...
    sections: [
      {
        ...
        entriesLists: [
          [
            { text: 'Course Intro' },
            { text: 'notes', link: 'https://docs.google.com/document/d/1_18W3dSNqxgCgnq28isyrUitQw1ics5ytn84D407PbU/edit?usp=sharing' },
          ],
          [
            { text: 'Git and GitHub' },
            { text: 'notes', link: 'https://docs.google.com/document/d/1xE-s_V4OuLuSE-0-pvQqolKVyzOFuHkwHT-9NMJR7Xk/edit?usp=sharing' },
          ],
          [
            { text: 'HTML' },
      ...
      },
      {
        ...
        entriesLists: [
          ...
          [
            { text: 'Introduction to HTML', link: 'https://developer.mozilla.org/en-US/docs/Learn/HTML/Introduction_to_HTML' },
            { text: 'MDN' }
          ]
        ]
      }
  ...
  //       heading: 'Topics',
  //       entriesHTML: [
  //         'MongoDB &ndash; <a href="https://docs.google.com/document/d/1kRFCS2htU1WPgRn4Gwk-VLl-9wd-pIEEDwF3I73JQhc/edit?usp=sharing">notes</a> &ndash; <a href="https://github.com/OSU-CS290-F17/using-mongodb">example code</a>'
  //       ]
  //     },
  //     {
  //       heading: 'Readings',
